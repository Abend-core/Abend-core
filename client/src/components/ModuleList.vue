<template>
  ...
  >
    ...
    >
      <a
        :href="module.link"
        class="module-card w-[300px] h-[175px] lg:w-[375px] lg:h-[210px] shadow-md rounded-2xl relative bg-gray-50 border border-gray-200 dark:bg-[#141A22] dark:border dark:border-black text-black dark:text-white"
        target="_blank"
      >
