<template>
  <div class="bg-white dark:bg-gray-800 py-0 mb-28">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <p
          class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-gray-200 sm:text-5xl lg:text-balance cursor-pointer hover:text-primaryRed transition-colors"
  ...
  <div class="bg-white dark:bg-gray-800 py-0" v-if="isModulesAdminVisible">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 mb-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <p
          class="mt-2 text-4xl font-semibold tracking-tighter uppercase text-pretty text-gray-900 dark:text-gray-200 sm:text-5xl lg:text-center cursor-pointer"
        >
          Modules des administrateurs
        </p>
      </div>
      <div class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
        <a
          v-for="(module, index) in modulesAdmin"
          :key="index"
