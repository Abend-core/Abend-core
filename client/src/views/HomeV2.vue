<template>
  <div>
    <div class="relative isolate px-6 pt-14 lg:px-8">
      <div
        class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-4xl sm:-top-80"
        aria-hidden="true"
      >
        <div
      ...
      <div class="mx-auto z-30 max-w-2xl py-6 sm:py-32 lg:py-48">
        ...
        <div class="text-center">
          ...
          >
            Créez votre propre <span class="text-primaryRed">hub</span> de liens
  ...
  <footer class="bg-white dark:bg-gray-800 m-4">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        >
          <li>
            <a href="#" class="hover:text-primaryRed me-4 md:me-6">About</a>
          </li>
          <li>
